...
function HomePage() {
  ...
  const filteredTickets = tickets.filter((ticket) => {
    ...
    if (
      filterUrgency !== "all" &&
      ticket.urgency.toString() !== filterUrgency
    ) {
      passesFilters = false;
    }
    ...
    if (ticketSearchQuery) {
      passesFilters = Object.values(ticket).some(
        (value) =>
          typeof value === "string" &&
          value.toLowerCase().includes(ticketSearchQuery.toLowerCase())
      );
    }
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        if (
          ...
          participants.every(
            (val, index) => val === selectedParticipants[index]
          )
        ) {
      ...
      if (existingThread) {
        ...
        console.error(
          "Error: Message thread with these participants already exists."
        );
    ...
    <div>
      ...
      <div className="home-container">
        ...
        <div className="content">
          <div className="messaging-section">
            ...
            <div className="messaging-new-thread">
              ...
              <button onClick={handleCreateMessageThread}>
                ...
                {messageThreads &&
                  messageThreads.map((thread) => (
                    <li key={thread.id}>
                      ...
                      <button
                        onClick={() => handleNavigateToMessageRoom(thread.id)}
                      >
                        {Array.isArray(thread.participantsNames)
                          ? thread.participantsNames.join(", ")
                          : ""}
                      </button>
                    </li>
                  ))}
          ...
          <div className="ticketing-section">
            <div className="ticketing-section-top-bar">
              ...
              <button onClick={handleToggleNewTicketForm}>
                {newTicketButtonText}
              </button>
            </div>
            ...
            <div className="filters">
              ...
              <div className="filter">
                ...
                <select
                  value={filterRelated}
                  onChange={handleRelatedFilterChange}
                >
                  <option value="all">All</option>
              ...
              <div className="filter">
                ...
                <select
                  value={sortByUrgency}
                  onChange={handleSortChangeByUrgency}
                >
                  <option value="all">All</option>
                  ...
                  <form onSubmit={handleTicketSubmission}>
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        name="availability"
                        value={newTicketData.availability}
                        onChange={handleInputChange}
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        name="related"
                        value={newTicketData.serviceType}
                        onChange={handleInputChange}
                      />
                    </div>
                    <div>
        ...
        <div className="footer">
          <p>
            &copy; 2024 Human Resources Development Council. All Rights
            Reserved.{" "}
          </p>
        </div>
      </div>
